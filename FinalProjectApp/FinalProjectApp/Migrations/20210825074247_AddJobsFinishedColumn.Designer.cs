...
namespace JobsForAll.Migrations
{
    ...
    [Migration("20210825074247_AddJobsFinishedColumn")]
    partial class AddJobsFinishedColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProjectApp.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FinalProjectApp.Models.Job", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("IsPriceNegociable")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FinalProjectApp.Models.Message", b =>
                {
                    ...
                    b.HasOne("FinalProjectApp.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("JobsForAll.Domain.Models.UserComment", b =>
                {
                    ...
                    b.HasOne("JobsForAll.Domain.Models.Comment", "Comment")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinalProjectApp.Models.ApplicationUser", null)
                        .WithMany()
